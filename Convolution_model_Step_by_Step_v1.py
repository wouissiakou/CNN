...
def conv_single_step(a_slice_prev, W, b):
    ...
    Z = s.sum()                         #Sum over all entries of the volume s.                                
    Z = Z+ b.sum()                     #Add bias b to Z. Cast b to a float() so that Z results in a scalar value.
...
def conv_forward(A_prev, W, b, hparameters):
    ...
    stride = hparameters.get("stride")                                    # Retrieve information from "hparameters"
